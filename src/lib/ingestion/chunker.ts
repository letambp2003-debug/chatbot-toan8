import { BookSet, ContentType, KnowledgeChunk, SourceType } from "@/types/knowledge";
...
export function chunkPageContent(rawPage: RawPageText): KnowledgeChunk[] {
  ...
  // Nhận diện chương & bài học từ văn bản
  ...
  // Cắt văn bản thành các đoạn hợp lý khoảng 300-600 từ
