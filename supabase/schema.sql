-- ============================================================================
-- GIA SƯ AI TOÁN 8 - CONSOLIDATED DATABASE SCHEMA
...
-- 8.1 RAW KNOWLEDGE PROTECTION (Students cannot direct read raw tables from browser)
...
-- 8.6 ADMIN / INGESTION / EVALUATION
